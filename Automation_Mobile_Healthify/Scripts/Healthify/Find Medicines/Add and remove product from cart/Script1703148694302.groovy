...
Mobile.tap(findTestObject('Object Repository/find medicines/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.view.View'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.widget.Button'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.widget.ImageView (1)'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.widget.Button (1)'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.widget.Button (2)'), 0)

Mobile.tap(findTestObject('Object Repository/find medicines/android.view.View (1)'), 0)
