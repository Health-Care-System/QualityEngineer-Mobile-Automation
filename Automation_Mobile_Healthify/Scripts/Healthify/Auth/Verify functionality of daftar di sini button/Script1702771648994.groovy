...
Mobile.startApplication('C:\\Users\\ferna\\Dropbox\\PC\\Downloads\\app-release-4.apk', true)

Mobile.tap(findTestObject('Login page/button daftar di sini'), 0)
...
//Mobile.swipe(startY, startX, endY, endX)
Mobile.tap(findTestObject('Login page/button login di sini'), 0)

Mobile.verifyElementVisible(findTestObject('Success login/android.widget.Button'), 0)
