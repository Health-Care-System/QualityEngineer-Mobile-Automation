...
Mobile.setText(findTestObject('verify alert failed to register/password field'), 'automated', 0)

Mobile.pressBack()

Mobile.verifyElementVisible(findTestObject('verify alert failed to register/alert password confirmation tidak sesuai'), 
    0)
